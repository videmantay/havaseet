...
'light-green' : '#8bc34a',
'light-green lighten-1': '#f1f8e9',
// 'lightGreen-lighten-2': '#dcedc8',
// 'lightGreen-lighten-3': '#c5e1a5',
// 'lightGreen-lighten-4': '#aed581',
// 'lightGreen-lighten-5': '#9ccc65',
// 'lightGreen-darken-1': '#7cb342',
// 'lightGreen-darken-2': '#689f38',
// 'lightGreen-darken-3': '#558b2f',
'light-green darken-4': '#33691e',
// 'lightGreen-accent-1': '#ccff90',
// 'lightGreen-accent-2': '#b2ff59',
// 'lightGreen-accent-3': '#76ff03',
// 'lightGreen-accent-4': '#64dd17',
'lime': '#cddc39',
'lime lighten-1': '#f9fbe7',
// 'lime-lighten-2': '#f0f4c3',
// 'lime-lighten-3': '#e6ee9c',
// 'lime-lighten-4': '#dce775',
// 'lime-lighten-5': '#d4e157',
...
//'blue-gray':  '#607d8b',
//'blue-gray lighten-1':  '#eceff1',
// 'blue-gray-lighten-2':  '#cfd8dc',
// 'blue-gray-lighten-3':  '#b0bec5',
// 'blue-gray-lighten-4':  '#90a4ae',
// 'blue-gray-lighten-5':  '#78909c',
// 'blue-gray-darken-1':  '#546e7a',
// 'blue-gray-darken-2':  '#455a64',
// 'blue-gray-darken-3':  '#37474f',
//'blue-gray darken-4':  '#263238',
 // 'gray': '#9e9e9e',
...
//     'gray-darken-3': '#424242',
  ...
  function colorpicker() {
    ...
    const $table = $( `<div style="height:200px" class="d-inline-flex flex-row"></div>`);
    let $row ;

    for(var i = 0; i < keys.length; i++) {
      if(i % 7 == 0) {
        $row = $(`<div class="d-inline-flex" style="padding:0 !important"></div>`);
        $table.append($row);
      }
      const $color = $(`<div class="${keys[i]} color-btn" title="${keys[i]}" style="height:1.5rem; width: 1.5rem; cursor:pointer" ></div>`);
      $row.append($color);  
    }
    return $table.html();
  }
